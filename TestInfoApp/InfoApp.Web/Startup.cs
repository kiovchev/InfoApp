...
namespace InfoApp.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<InfoAppDbContext>(options =>
            ...
            services
                ...
                .AddEntityFrameworkStores<InfoAppDbContext>()
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                using (var dbContext = serviceScope.ServiceProvider.GetRequiredService<InfoAppDbContext>())
                {
